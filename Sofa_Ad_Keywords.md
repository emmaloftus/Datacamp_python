...
words = ['buy', 'price', 'affordable', 'discount', 'promotion', 'sale']

# Print list of words
print(words)
```

    ['buy', 'price', 'affordable', 'discount', 'promotion', 'sale']
...
pd.DataFrame.to_csv(keywords_df_final, 'keywords.csv', index = False)
