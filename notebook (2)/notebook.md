...
ax = cap10.plot.bar(y= "market_cap_usd", color = COLORS);
plt.yscale("log");
plt.title(TOP_CAP_TITLE);
...
fig, ax = top10_subplot(volatility_series = volatility.percent_change_24h, 
                        title= DTITLE)
...
fig, ax = top10_subplot(volatility_series = volatility7d.percent_change_7d, 
                        title= WTITLE)
```
...
micro = capcount("market_cap_usd > 50e+6 and market_cap_usd < 30e+7")
